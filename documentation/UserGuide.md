...
- متابعة تقدم التنزيل بسرعة وسهولة.
...
تحتوي قائمة التنزيلات على الملفات التي يتم تنزيلها، مع كل ملف يتم عرض بيانات تتيح لك معرفة حالته وتقدم تنزيله، وتتوفر اختصارات لوحة المفاتيح لقراءة كل معلومة بسرعة.
...
عند فتح خيارات أي ملف عن طريق مفتاح التطبيقات أو Right click أو مفتاح الإدخال Enter, ستجد الخيارات التالية التي تتغير بحسب حالة الملف الحالي أو حالة التنزيل لكل الملفات.
...
تعمل هذه الاختصارات في [نافذة مدير التنزيلات](#Download managerWindow) وتتيح لك التفاعل مع النافذة.
...
#### اختصارات خيارات التنزيت {#DownloadsOptionsShortcuts}

تعمل هذه الاختصارات عند التركيز على ملف من قائمة التنزيلات وضغط مفتاح التطبيقات Applications أو مفتاح الإدخال Enter على أي ملف.
...
تعمل هذه الاختصارات على نطق معلومات الملف الحالي الذي يتم التركيز عليه بحسب توفرها.
