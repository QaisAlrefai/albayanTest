...
### خصائص إضافية في التنزيلات {#DownloadsAdditionalFeatures}

راجع خيارات الآيات لتنزيل آيات من النافذة الرئيسية.

راجع خيارات السور لتنزيل السور من مشغل القرآن.

راجع [إعدادات التنزيلات](#DownloadSettings) لتخصيص خيارات التنزيل.
