...
ينقسم مدير التنزيلات إلى عدة نوافذ للتفاعل مع الملفات التي يتم تنزيلها، كما تتيح إضافة تنزيلات جديدة.
...
- قائمة التنزيلات: قائمة تعرض الملفات التي تمت إضافتها للتنزيل مع حالتها, تشمل: رقم الملف, اسم ورقم السورة أو الآية، الحجم، الوقت المنقضي والمتبقي، نسبة التقدم، حالة الملف، السرعة، وغير ذلك.
- تنزيل جديد: زر لإضافة وبدء تنزيل جديد، تظهر خيارات [تنزيل سور](#DownloadSurahs) أو [تنزيل آيات](#DownloadAyahs).
- حذف: زر لعرض [خيارات الحذف](#DeleteOptions) التي تنطبق على عدة ملفات.
- إغلاق: زر لإغلاق نافذة التنزيل.

عند ضغط مفتاح الإدخال Enter في أي مكان في النافذة باستثناء زر الإغلاق، يتم فتح قائمة تنزيل جديد.

تتوفر [خيارات](#DownloadsOptions) للتنزيلات عند ضغط مفتاح التطبيقات applications على أي عنصر.

### خيارات التنزيلات {#DownloadsOptions}

عند فتح خيارات أي ملف عن طريق مفتاح التطبيقات أو Right click ستجد الخيارات التالية التي تتغير بحسب حالة الملف.
...
- إيقاف مؤقت: يظهر مع الملفات التي يجري تنزيلها، يتيح إيقاف تنزيل الملف مؤقتًا حيث يمكن استئناف التنزيل لاحقًا.
- استئناف: يظهر مع الملفات التي تم إيقاف تنزيلها مؤقتًا، يتيح استئناف تنزيل الملف.
- إلغاء التنزيل: يظهر مع الملفات التي يتم تنزيلها أو في قائمة الانتظار، يتيح إلغاء تنزيل الملف الحالي.
إلغاء تنزيل الكل: يظهر مع الملفات التي يتم تنزيلها أو في قائمة الانتظار، يتيح إلغاء تنزيل كل الملفات التي لم يكتمل تنزيلها.
- بدء التنزيل: يظهر مع الملفات التي يتم تنزيلها أو في قائمة الانتظار، يتيح بدء تنزيل العنصر المحدد.
- بدء تنزيل الكل: يظهر مع الملفات التي يتم تنزيلها أو في قائمة الانتظار، يتيح بدء تنزيل كل الملفات التي لم يكتمل تنزيلها.
...
- قيد الانتظار: تشير إلى الملفات التي سيتم تنزيلها، يتم إضافة من 1 إلى 5 ملفات في قائمة التنزيل المباشر، ويتم وضع بقية الملفات في قائمة الانتظار حتى يكتمل تنزيل الملفات الحالية فيبدأ تنزيل المزيد.
...
راجع إعدادات التنزيلات لتخصيص خيارات التنزيل.
