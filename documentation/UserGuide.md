...
- القسم: صندوق خيارات يحدد عرض السور أو الآيات.
- تصفية: لتصصفية وفلترة قائمة التنزيلات، تتوفر العديد من [حالات التنزيل](#DownloadStatuses).
- قائمة التنزيلات: قائمة تعرض الملفات التي تمت إضافتها للتنزيل مع حالتها.
...
- حذف العنصر المحدد: لحذف الملف من الجهاز ومن سجل تنزيلات البيان.
- إعادة المحاولة: لإعادة محاولة تنزيل الملف.
- إلغاء التحميل: لإلغاء تحميل الملف الحالي.
إلغاء تحميل الكل: لإلغاء تحميل كل الملفات التي لم يكتمل تنزيلها.
- بدء التحميل: لبدء تنزيل العنصر المحدد.
- بدء تحميل الكل: لبدء تنزيل كل الملفات التي لم يكتمل تنزيلها.
...
- تحميل: زر لبدء التنزيل والعودة إلى نافذة التنزيلات.
...
- جاري التنزيل: تشير إلى الملفات التي يجري تنزيلها.
