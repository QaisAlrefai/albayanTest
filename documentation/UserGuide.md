...
- حذف العنصر المحدد: يظهر مع جميع الملفات، لحذف الملف من الجهاز ومن سجل تنزيلات البيان.
- إعادة المحاولة: يظهر مع الملفات التي فشل تنزيلها، أي حالتها خطأ، لإعادة محاولة تنزيل الملف.
- إيقاف مؤقت: يظهر مع الملفات التي يجري تنزيلها، لإيقاف تنزيل الملف مؤقتًا حيث يمكن استئناف التنزيل لاحقًا.
- استئناف: يظهر مع الملفات التي تم إيقاف تنزيلها مؤقتًا، يتيح استئناف تنزيل الملف.
- إلغاء التنزيل: يظهر مع الملفات التي يتم تنزيلها أو في قائمة الانتظار، لإلغاء تنزيل الملف الحالي.
إلغاء تنزيل الكل: يظهر مع الملفات التي يتم تنزيلها أو في قائمة الانتظار، لإلغاء تنزيل كل الملفات التي لم يكتمل تنزيلها.
- بدء التنزيل: يظهر مع الملفات التي يتم تنزيلها أو في قائمة الانتظار، لبدء تنزيل العنصر المحدد.
- بدء تنزيل الكل: يظهر مع الملفات التي يتم تنزيلها أو في قائمة الانتظار، لبدء تنزيل كل الملفات التي لم يكتمل تنزيلها.

### شريط تقدم التنزيل {#DownloadProgressBar}

يوجد شريط تقدم لتنزيل الملفات، لكنه لا يعمل بحسب الملف.

يظهر شريط التقدم في نافذة التنزيلات ويعرض تقدم التنزيل بحسب الملفات، وليس بحسب النسبة أو الحجم.
